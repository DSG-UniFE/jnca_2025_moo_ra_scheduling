...
# ╔═╡ 2f2ee962-3ad5-11ef-39c0-17d47e04939d
using JuMP, DataFrames, CSV, Gurobi, Plots

# ╔═╡ 30343a1a-d2e4-45fc-95a4-b7282458bdc7
import MultiObjectiveAlgorithms as MOA

# ╔═╡ 9e8d00a3-943e-4c69-956e-864d6bb9b997
import MathOptInterface as MOI

# ╔═╡ 9b2bc9f7-cca4-4c8b-a18f-71a0bd785c83
...
# ╔═╡ a21d7b5a-c504-4f2a-9947-afddfab0b47a
function create_model(DC, I, D, T, l, CO, CR, CS, C, M, f, c, m, R, Ir, Io, Is, Dt, N, duration)
	...
	set_attribute(model, MOI.TimeLimitSec(), 300)
...
# ╔═╡ a9a82752-b676-49f1-967b-7716904e7ea2
begin
...
# ╔═╡ a97aa4b1-8041-471c-8bbc-7d6ba44f4868
optimize!(model)

# ╔═╡ d4eef3e0-98e7-420c-b149-86fd32616a32
solution_summary(model)

# ╔═╡ 2678e6a0-b9bb-4883-b9b5-0b25cee5a03a
...
manifest_format = "2.0"
project_hash = "a233663cbeaff22c1dd3237b3a090062b92faed7"
...
[[deps.Gurobi_jll]]
deps = ["Artifacts", "JLLWrappers", "Libdl"]
git-tree-sha1 = "2c479baa567450b25f69f4a0885fd13c2039bcd1"
...
git-tree-sha1 = "8204d367d64d99fdcc530259b47af3d0f79825af"

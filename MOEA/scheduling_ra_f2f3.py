...
class SchedulingRAF2F3(IntegerProblem):
    """Multi-Cluster problem"""

    def __init__(self):
        super(SchedulingRAF2F3, self).__init__()
        self.load_requests_data("./cnsm_data/Services.csv")
        self.load_instances_data(
            "./cnsm_data/AWS_EC2_Pricing.csv", "./cnsm_data/AWS_EC2_Latency.csv"
        )
        print(
        ...
        self.num_combinations = (
            self.num_datacenters * 3 * 3
        )  # 3 tipi di istanza, 3 prezzi (on-demand, reserved, spot)

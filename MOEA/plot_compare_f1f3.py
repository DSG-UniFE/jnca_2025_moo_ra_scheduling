    ...
    with open(filename, newline="") as csvfile:
        ...
        for row in reader:
            ...
            with open(output_filename, "w") as outfile:
                for lat, c in zip(latency, unavailability):
...
def main():
    ...
    for usecase in dir_usecases_ilp:
        ...
        os.makedirs(output_dir, exist_ok=True)
        objectives_files_ilp = glob.glob(f"{usecase}f1_f3/results*_mac.csv")
    ...
    for usecase in dir_usecases_meta:
        ...
        ilp_solutions_dict = {}
        objectives_files_ilp = glob.glob(f"../results/usecase/{usecase}/objectives_f1_f3/*.txt")
        ...
        combined_plot_path = os.path.join(result_dir,  f"combined_plot_{usecase_name}_f1f3.pdf")
